...
export default function SendToTeasher() {
  ...
  fetch("/api/forms") // replace with your API endpoint
    .then((res) => res.json())
    .then((data) => {
      const approvedForms = data.datas.filter(form => form.approval === 'approved');
                  ...
                  <div className="card-header border-primary">
                    <div className="row justify-content-start align-items-center" >
                      ...
                      <div className="col-lg-8  col-12">
                        <p className="mb-0"> {student ? student.name : 'Student not found'}</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="card-body">
                    <div className="row align-items-center justify-content-start mb-2" >
                      ...
                      <div className="col-lg-8  col-sm-12">
                        <p className="card-text"> {student ? student.number: 'Student not found' } </p>
                      </div>
                    </div>
                    ...
                    <div className="row align-items-center justify-content-start mb-2" >
                      ...
                      <div className="col-lg-8  col-sm-12">
                        <p className="card-text"> { student ? student.class: 'Student not found'}</p>
                      </div>
                    </div>
                    ...
                    <div className="row align-items-center justify-content-start mb-3 pb-2 border-bottom border-primary" >
                      ...
                      <div className="col-lg-8  col-sm-12">
                        <p className="card-text"> {student ? student.year: 'Student not found'} </p>
                      </div>
                    </div>
                    ...
                    <form action="">
                      ...
                      <div className="row align-items-center justify-content-start " >
                        ...
                        <div className="col-lg-8  col-sm-12">
                          <textarea className="form-control" id="exampleFormControlTextarea1" rows="3" defaultValue={`ارجو السماح للطالب ${student ? student.name : ''} بالسماح له بالخروج`}></textarea>
                        </div>
                        <div className="sendToteacherButton text-center">
                          <button type="button" className="btn btn-primary mt-3" onClick={(event) => handleSubmit(event, form.id)}>ارسال</button>
                        </div>
                      </div>
