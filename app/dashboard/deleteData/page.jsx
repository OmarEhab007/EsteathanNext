                    ...
                    <div className="col-12 col-md-6 mb-3">
                        <div className="card border-danger">
                            <div className="card-body">
                                <h5 className="card-title text-center">حذف بيانات الطلاب</h5>
                                <p className="card-text text-center">يمكنك حذف بيانات جميع الطلاب من هنا  </p>
                                <button type='button'  className="btn btn-danger mx-auto d-block">حذف البيانات</button>
                            </div>
                        </div>
                    </div>
                    <div className="col-12 col-md-6 mb-3">
                        <div className="card border-danger">
                            <div className="card-body">
                                <h5 className="card-title text-center">حذف بيانات المعلمين</h5>
                                <p className="card-text text-center">يمكنك حذف بيانات جميع المعلمين من هنا </p>
                                <button type='button' className="btn btn-danger mx-auto d-block">حذف البيانات</button>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div className="card-body">
                                        ...
                                        <form action="">
                                            <div class="form-floating mb-3">
                                                <input type="search" class="form-control" id="studentSearch" placeholder="ابحث باسم الطالب"/>
                                                <label for="studentSearch"> ابحث باسم الطالب </label>
                                            </div>
                                        </form>
                                    </div>
                                </div>
                                    ...
                                    <div className="card border-info">
                                        ...
                                        <div className="card-body">
                                            ...
                                            <form action="">
                                                ...
                                                <button type="button" className="btn btn-danger text-center m-auto d-block"> حذف الطالب </button>
