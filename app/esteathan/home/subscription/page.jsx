                            ...
                            <form action="">
                                ...
                                <div className="row group p-1 mb-2">
                                    ...
                                    <div className='mb-3 col-lg-6'>
                                        ...
                                        <input type="text" id='schoolName' className='form-control' placeholder='اسم المدرسة' />
                                    </div>
                                    <div className='mb-3 col-lg-6'>
                                        <label htmlFor="schoolNumber" className='form-label'> الرقم الوزاري </label>
                                        <input type="number" id='schoolNumber' className='form-control' placeholder='الرقم الوزاري' />
                                    </div>
                                    <div className='mb-3 col-lg-6'>
                                            <label htmlFor="city" className='form-label'> المنطقة التعليمية </label>
                                            <input type="text" id='city' className='form-control' placeholder='المنطقة التعليمية' />
                                        </div>
                                        <div className='mb-3 col-lg-6'>
                                            <label htmlFor="educationOffice" className='form-label'> المكتب التابع له المدرسة </label>
                                            <input type="text" id='educationOffice' className='form-control' placeholder='المكتب التابع له المدرسة' />
                                        </div>
                                </div>
                                ...
                                <div className="row group p-1  mb-2">
                                    ...
                                    <div className='mb-3 col-lg-6'>
                                        <label htmlFor="name" className='form-label'> اسم المسئول </label>
                                        <input type="text" id='name' className='form-control' placeholder='اسم المسؤول' />
                                    </div>
                                    <div className='mb-3 col-lg-6'>
                                        <label htmlFor="phoneNumber" className='form-label'> رقم الجوال مفعل فيه الوتساب </label>
                                        <input type="number" id='phoneNumber' className='form-control' placeholder='رقم الجوال مفعل فيه الوتساب' />
                                    </div>
                                </div>
                                ...
                                <div className="row group p-1  mb-2">
                                    ...
                                    <div className='mb-3 col-lg-6'>
                                        <UploadButton
                                            content={{
                                            button({ ready }) {
                                                if (ready) return <div>ارفاق صوره ايصال الدفع <i class="fa-regular fa-image"></i></div>;
                                ...
                                <div className='text-center mt-3 '>
                                    <button className='btn px-5 esteathan-btn'> اشتراك </button>
                                </div>
                            </form>
                        </div>
                    </div>
